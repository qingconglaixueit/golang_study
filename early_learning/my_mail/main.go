...
func main() {
	...
	em := email.NewEmail()
	//设置发送方的邮箱
	em.From = "xx <502892037@qq.com>"
	// 设置接收方的邮箱
	em.To = []string{"502892037@qq.com"}

	// 抄送
	em.Cc = []string{"502892037@qq.com"}

	// 密送
	em.Bcc = []string{"502892037@qq.com"}
...
`)
	...
	//设置服务器相关的配置
	err := em.Send("smtp.qq.com:25", smtp.PlainAuth("", "502892037", "muahhmqlnrmobjii", "smtp.qq.com"))
	if err != nil {
		log.Fatal(err)
	}
