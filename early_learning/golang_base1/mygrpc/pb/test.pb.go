...
var file_test_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x74, 0x32, 0x31, 0x0a, 0x04, 0x4c, 0x6f, 0x76, 0x65, 0x12, 0x29, 0x0a, 0x0a, 0x43,
	0x6f, 0x6e, 0x66, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x0b, 0x2e, 0x70, 0x62, 0x2e, 0x52,
...
var file_test_proto_depIdxs = []int32{
	0, // 0: pb.Love.Confession:input_type -> pb.Request
	1, // 1: pb.Love.Confession:output_type -> pb.Response
...
// LoveClient is the client API for Love data_svr.
//
...
func (c *loveClient) Confession(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/pb.Love/Confession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// LoveServer is the server API for Love data_svr.
